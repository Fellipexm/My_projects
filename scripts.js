document.addEventListener('DOMContentLoaded', function() {
    ...
    const projectsData = [
        ...
        },
        {
            ...
            description: 'Gostaria compartilhar o projeto incrível que nossa equipe de TI desenvolveu: Martinho de Minas! 🛒 Com o objetivo de facilitar a vida dos clientes, criamos um aplicativo que não apenas ajuda a encontrar corredores nos supermercados, mas também gera um mapa com a rota ideal. Além disso, o app informa promoções nos corredores que o cliente percorrerá, tornando a experiência de compras mais eficiente e econômica.Utilizamos tecnologias como React Native para a interface, Node para o backend, e Postgres como banco de dados. Atuei no projeto como DevOps, tive a oportunidade de coordenar a infraestrutura essencial para o sucesso do aplicativo. Utilizamos tecnologias como React Native para a interface, Node.js para o backend, e Postgres como banco de dados. Enfrentei desafios significativos, como encontrar um serviço em nuvem adequado, trabalhar com AWS, Docker e Kubernetes para garantir escalabilidade e confiabilidade. Inicialmente, gerenciar o tempo e distribuir tarefas foram desafios, mas aprendi a superá-los ao longo do projeto. Estou orgulhoso por ter contribuído para transformar a experiência de compras dos nossos clientes, proporcionando uma solução eficiente e econômica. Agradeço por fazer parte de uma equipe tão talentosa e dedicada!.',
