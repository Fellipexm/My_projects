document.addEventListener('DOMContentLoaded', function() {
    ...
    const projectsData = [
        ...
        },
        {
            ...
            description: 'O dispositivo possui interação comunicacional e sem fio com smartphones, com a finalidade de informar a situação do semáforo aos pedestres com deficiência visual. Utilizando recursos como tecnologia Arduino, relés e shields de comunicação Wi-Fi, juntamente com habilidades de prototipação, design tridimensional e fabricação por impressão 3D, a iniciativa não só melhora a acessibilidade para pessoas, como contribui para a segurança nas vias públicas. Além disso, fomenta a cultura maker e a inovação tecnológica.',
            link: 'https://drive.google.com/file/d/1HBDPOFrxuw5vW6TRnerTXF8nQUG4R8xc/view?usp=sharing',
            image: 'assets/semafaro.jpg'
        },
        {
            title: 'Lan House',
            description: 'Construímos uma Lan house do zero no curso de Ti. Crimpamos todos os cabos RJ-45, fazendo o cabeamento estruturado usando os patch panels do rack e o switch. Montamos, formatamos e configuramos as máquinas clientes. Formatamos e configuramos o servidor que está dentro do rack com os serviços de http, ftp, dhcp e proxy. Aproveitamos para jogar uma partida de CS em Lan para testar nossa rede.',
    ...
    projectsData.forEach(project => {
        ...
        if (project.repo) {
            ...
            repoLinkElement.textContent = 'Ver repositório';
